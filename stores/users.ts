...
export const useUsersStore = defineStore("users", () => {
    ...
    return { userData, signIn, signOut, getUser, createUser, getUsers, getNormalizedDate, getISODateTime, updateUser, deleteUser, getNormalizedDateWithoutTime, getISODate }
})