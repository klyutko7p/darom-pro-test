...
<template>
  ...
  <div v-if="!isLoading">
    <div v-if="token">
      <div class="py-10">
        <h1 class="font-bold text-4xl max-md:text-3xl max-sm:text-2xl max-md:text-center mb-3">Инструкция для оформления заказа</h1>
        <ul class="list-decimal max-md:px-3">
          <li class="mb-3 text-xl max-md:text-lg max-sm:text-base">
            ...
            <span class="italic font-bold">Ростовская обл, Матвеево-Курганский р-н, с. Ряженое, ул. Ленина 6</span>
          </li>
          <li class="mb-3 text-xl max-md:text-lg max-sm:text-base">
