...
<template>
  <aside
    ...
    class="fixed top-0 left-0 z-[200] w-72 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar"
  >
    <div
      v-auto-animate
    ...
    >
      ...
      >
        ...
        >
          <Icon name="material-symbols:close-small-outline-rounded" size="32" />
        </div>
      </div>
      ...
      <div v-auto-animate class="px-3">
          ...
          >
            ...
            <li>
              <div
                ...
                @click="showGoodsList"
                v-if="
                  user.username !== 'Шарафаненко' && user.username !== 'Косой' && user.username !== '+7'
                "
              >
                <Icon
                  class="text-gray-500 transition duration-75 group-hover:text-gray-900"
        ...
        <div v-auto-animate v-if="isShowGoodsList">
          ...
          <ul class="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span
                  v-if="
                    user.username === 'Директор' && quantityRequiredARRowsAdmin
                  "
                  class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300"
                >
                  {{ quantityRequiredARRowsAdmin }}
